...
cmd_begin_rendering_target :: proc(frame: Frame, target: Render_Target, clear_color: [4]f32 = {0, 0, 0, 1}, loc := #caller_location) {
...
cmd_bind_index_buffer :: proc(frame: Frame, buffer: vk.Buffer, offset: vk.DeviceSize = 0, index_type: vk.IndexType = .UINT32, loc := #caller_location) {
...
cmd_draw :: proc(frame: Frame, vertex_count: u32, instance_count: u32 = 1, first_vertex: u32 = 0, first_instance: u32 = 0, loc := #caller_location) {
...
@(private)
host_cmd_push_constants :: proc(frame: Frame, pipeline: GPU_Pipeline, data: rawptr, size: int, loc := #caller_location) {
...
@(private)
host_cmd_bind_index_buffer :: proc(frame: Frame, buffer: vk.Buffer, offset: vk.DeviceSize = 0, index_type: vk.IndexType = .UINT32) {
...
@(private)
host_cmd_draw :: proc(frame: Frame, vertex_count: u32, instance_count: u32 = 1, first_vertex: u32 = 0, first_instance: u32 = 0) {
	vk.CmdDraw(frame.cmd, vertex_count, instance_count, first_vertex, first_instance)
}

@(private)
host_cmd_draw_indexed :: proc(frame: Frame, index_count: u32, instance_count: u32 = 1, first_index: u32 = 0, vertex_offset: i32 = 0, first_instance: u32 = 0) {
